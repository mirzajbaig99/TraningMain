...
namespace Mirza09112017.com.week10._10exDynamic
{
    ...
    public class ExReflection
    {
        public static void Main(string[] arg)
        {
            ...
            t.InvokeMember("Set", BindingFlags.InvokeMethod | BindingFlags.Instance | BindingFlags.Public,
                    null, Activator.CreateInstance(t,1), methodData);
            callingmethod.Invoke(Activator.CreateInstance(t,1),methodData);
            Console.ReadKey();
        }
    }
}
